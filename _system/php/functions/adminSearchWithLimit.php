...
if(isset($query)){
    try {
        ...
        # Perform SQL Query
        $stmt = $conn->prepare(
            "( SELECT 'accounts' as source_table, account_id, NULL as booking_id, account_name, NULL as subject_name, NULL as booking_date FROM accounts WHERE account_id LIKE '%$query%' OR account_name LIKE '%$query%' LIMIT 5 ) UNION
